...
const Footer = () => {
  return (
    <footer className="w-full bg-[#3D4049] py-10 text-white">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-12 px-6 md:px-12 lg:flex-row lg:gap-0">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <a
            ...
            className="rounded-md border border-gray-300 px-6 py-2 text-gray-300 hover:bg-gray-500/20 text-center"
          >
            CALL
          </a>
        </div>
