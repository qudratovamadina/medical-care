...
const Services = () => {
  return (
    <section id="services" className="bg-white py-16 text-gray-900">
      <div className="container mx-auto px-6 md:px-0 lg:flex lg:items-center lg:space-x-8">
        {/* Left Text Content */}
      ...
      <div className="container mx-auto mt-16 px-6 md:px-12">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 text-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {[
